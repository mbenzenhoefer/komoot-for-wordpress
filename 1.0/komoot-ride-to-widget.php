<?php
/*
	Plugin Name: komoot Anfahrt mit dem Rad Widget
	Plugin URI: http://www.komoot.de/
	Description: Mit diesem Widget kannst den Besuchern deiner Seite einen Tourenplaner f&uuml;rs Fahrrad bieten.
	Author: komoot GmbH
	Version: 1.0
